        ...
        try {
            ...
            if (response.status) {
                ...
                Swal.fire({
                    icon: "success",
                    title: "Saved",
                    text: "Customer Contact successfully",
                });
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 ">
            <div className="bg-white rounded-lg shadow-xl max-w-5xl w-full max-h-[90vh] ">
                <div className=" bg-white border-b border-slate-200 px-6 py-4 flex justify-between items-center rounded-lg">
                    ...
                    <div className='grid md:grid-cols-2 gap-6'>
                        <div>
                            ...
                            <textarea
                                ...
                                rows={5}
                                className="w-full px-4 py-2.5 border border-slate-300 rounded focus:ring-4 focus:ring-primary/20 focus:border-primary focus:outline-none resize-none"
                            />
                        </div>
                        <div>
                            <div>
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    className="w-full px-4 py-1.5 border border-slate-300 rounded focus:ring-2 focus:ring-primary/20 focus:border-primary focus:outline-none"
                                >
                ...
                <div className="sticky bottom-0 bg-slate-50 border-t border-slate-200 px-6 py-4 flex justify-end gap-3 rounded-md">
                    ...
                    <Button disabled={!isValid || saveLoading} className="gradient-primary hover:opacity-90" onClick={handleSave}>
