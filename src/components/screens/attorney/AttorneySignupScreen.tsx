...
import { ArrowRight, Building, Eye, EyeOff, Home, Lock, Mail, MapPin, Phone, Scale, User } from "lucide-react"
...
import ErrorBox from "@/components/Parts/ErrorBox";
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <select
                                    ...
                                    className="w-full pl-4 pr-4 py-1.5 border border-slate-200 rounded-xl focus:border-primary focus:ring-4 focus:ring-input outline-none transition-all bg-white"
                                    required
                                >
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative group">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-12 pr-12 py-1.5 border border-slate-200 rounded-xl focus:border-primary focus:ring-4 focus:ring-input outline-none transition-all bg-white"
                                        placeholder="••••••••"
                                        required
                                    />
                                    <button
