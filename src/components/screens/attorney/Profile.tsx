        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div>
            <button
              ...
              className="w-full sm:w-auto px-6 py-2 bg-primary/60 text-white rounded-lg font-medium hover:bg-primary/80 transition-colors">
              Edit Profile
            </button>
          </div>
          ...
          <div className="p-4 sm:p-6 lg:p-8">
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 mb-8">
              <div className="relative">
                ...
                <button className="absolute bottom-0 right-0 w-8 h-8 sm:w-10 sm:h-10 bg-primary/80 rounded-full flex items-center justify-center hover:bg-blue-700 transition-colors">
            ...
            <div className="space-y-8">
              ...
              <div className="border-t border-gray-200 pt-8">
                <button
                  ...
                  className="flex items-center gap-2 text-primary/70 hover:text-primary font-medium"
                >
