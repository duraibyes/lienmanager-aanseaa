...
const ChangePassword = ({ setShowPasswordModal }: { setShowPasswordModal: () => void }) => {
                ...
                <form onSubmit={handlePasswordChange} className="space-y-4">
                    ...
                    <div className="flex gap-3 mt-6">
                        ...
                        <button
                            ...
                            className={`flex-1 px-4 py-2 ${isFormValid ? 'bg-blue-600 hover:bg-blue-700 ' : 'bg-gray-600 hover:bg-gray-700'} text-white rounded-lg hover:bg-blue-700 transition-colors`}
                        >
                            Update Password
                        </button>
                    </div>
