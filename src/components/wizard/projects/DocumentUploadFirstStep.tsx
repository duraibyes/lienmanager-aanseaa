...
export default function DocumentUploadFirstStep({ data, onUpdate, onNext }: DocumentUploadFirstStepProps) {
  ...
  return (
    <div className="max-w-4xl mx-auto md:p-8 md:py-12 p-4">
      ...
      <div className="bg-white rounded-xl border-2 border-slate-200 md:p-8 p-4 space-y-6">
        <div className="border-2 border-dashed border-slate-300 rounded-xl md:p-12 p-6 text-center hover:border-primary/40 hover:bg-primary/10 transition-all cursor-pointer relative">
          <input
            type="file"
        ...
        {extracting && (
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 text-center">
            <Loader className="w-8 h-8 text-primary/60 mx-auto mb-3 animate-spin" />
            <h3 className="font-semibold text-primary mb-2">Extracting Information...</h3>
