...
export const AuthLeftAttorneyPanel = () => {
    return (
            ...
            <div className="relative z-10 flex flex-col justify-center items-center w-full p-12">
                <div className="max-w-md text-center space-y-8">
                    ...
                    <h1 className="text-3xl font-serif font-bold text-white text-balance">
                        Manage Your Legal Liens with Precision
                    </h1>

                    <p className="text-white/70 text-lg leading-relaxed">
                        Handle client lien cases, track legal deadlines, and ensure compliance with state laws—all in one platform built for legal professionals.
                    </p>
                    ...
                    <div className="flex flex-col gap-4 pt-4">
                        <div className="flex items-center gap-3 text-white/80">
                            ...
                            <span>Track case deadlines and court timelines</span>
                        </div>
                        <div className="flex items-center gap-3 text-white/80">
                            <div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center">
                                <span className="text-sm font-semibold">2</span>
                            </div>
                            <span>Manage client files and legal documents</span>
                        </div>
                        <div className="flex items-center gap-3 text-white/80">
                            <div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center">
                                <span className="text-sm font-semibold">3</span>
                            </div>
                            <span>Ensure compliance with lien laws and regulations</span>
                        </div>
                    </div>
                </div>
            </div>
